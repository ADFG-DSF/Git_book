...
-   @sec-collab describes using Git and GitHub to store your work on GitHub. In the chapter collaborators can take several meanings: you can collaborate with yourself by using GitHub to allow you to modify your analysis from two locations, you can collaborate with a peer to improve each others' analysis, and/or you can collaborate with your professional predecessor and descendants by keeping your analysis discoverable.
