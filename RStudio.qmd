...
-   `git checkout` to recall a single file from a previous commit.
    ...
    -   comment - I've done this a lot. It is sometimes possible to cut/paste a piece of revised code from the GUI history but it is usually formatted poorly which can be a pain if the section you need is large.
